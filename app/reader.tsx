...
export default function ReaderScreen() {
  ...
  const { chapterId, chapterNum, mangaTitle, isLN, url } =
  ...
  return (
    <View style={styles.root}>
      ...
      {headerVisible && (
        <SafeAreaView
          edges={["top"]}
          style={[styles.header, { borderBottomColor: accent + "33" }]}
        >
      ...
      {isLightNovel ? (
        ...
        url ? (
          ...
          <View style={styles.center}>
            ...
            <Text style={styles.errorText}>
              No readable URL for this chapter.
            </Text>
            <Text style={styles.errorSub}>
              Try opening it from the source website.
            </Text>
          </View>
        )
      ) : isLoading ? (
        ...
        <View style={styles.center}>
          ...
          />
          <Text style={styles.errorText}>
            Manga reading is unavailable in this tracker build.
          </Text>
          <Text style={styles.errorSub}>
            This app now uses AniList for manga information only.
          </Text>
          <Pressable
            onPress={() => router.back()}
